                    ...
                    <div class="highlight">
                        ...
                        <div class="buttons">
                            ...
                            <div class="checkbox" onclick="selectHighlight('no');" data-highlight="no">
                                ...
                                <p>Không ({{ $countPosts - $countHighlighted }})</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="buttons">
                            ...
                            @foreach($categories as $category)
                                ...
                                @if($elements >= 3 && $loop->index + 1 == $elements && !isset($selected_categories))
                                    <p class="categories_extend" onclick="categoriesToggle();"><i class="fa-solid fa-chevron-down"></i> Xem thêm</p>
                                @endif
                            @endforeach
                        </div>
                    </div>
                    <div class="user">
                        <p class="name">Người dùng</p>
                        <div class="buttons">
...
<x-floating-button icon="fa-plus" url="{{ route('posts.create') }}" />
