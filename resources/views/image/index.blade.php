    ...
    <div class="images">
        ...
        <div class="image_modal" style="display: none;">
            ...
            <div class="file_info">
                ...
                <div class="usage_count"><i class="fa-solid fa-recycle"></i> Đã dùng: <span>0</span></div>
                <button class="button" onclick="deleteImage(event);" data-name="na">Xóa <i class="fa-solid fa-trash" aria-hidden="true"></i></button>
                <div class="use_info">Được dùng trong:</div>
                <div class="used">
                    <div class="post">
                        <img src="" alt="">
                        <div class="info">
                            <div class="type">Bài viết</div>
                            <div class="location">Nội dung</div>
