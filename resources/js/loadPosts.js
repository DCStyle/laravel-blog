...
function addPostTiles(data) {
    data.forEach(post => {
        ...
        if (isHighlighted) {
            ...
            highlightedIcon.textContent = "Nổi bật ";
        ...
        readDiv.innerHTML = `<i class="fa-solid fa-angles-right" aria-hidden="true"></i>Đọc`;
        ...
        readingTime.textContent = `${post.read_time} phút`;
