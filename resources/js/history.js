...
window.revert = function (postId, historyId) {
    Swal.fire({
        ...
        html: "Bạn có chắc chắn muốn khôi phục không? <p style='font-size: 15px; font-weight: 400; margin-top: 5px;'>Thông tin:<br>Sau khi khôi phục, bài viết sẽ được cập nhật và bạn có thể chỉnh sửa.</p>",
        icon: "warning",
...
window.extend_history = function () {
    ...
    if (history_list.style.height === '0px') {
        ...
        extend_history.innerHTML = "Ẩn lịch sử";
    } else {
        history_list.style.height = '0px';
        history_list.style.visibility = 'hidden';
        extend_history.innerHTML = "Hiển thị lịch sử";
    }
