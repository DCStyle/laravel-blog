...
class PostAdminController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Auth::User()->notify(new PostNotification('SUCCESS', 'Đã tạo bài đăng!', "/post/$post->slug"));
        ...
        if ($method === "PATCH") {
            ...
            if (!empty($changelog)) {
                ...
                if (Auth::Id() !== $post->user_id) {
                    $post->user->notify(new PostNotification('INFO', 'Bài viết đã được chỉnh sửa bởi '.Auth::User()->firstname.' '. Auth::User()->lastname. '.', "/dashboard/posts/$post->id/edit/history/current/show"));
                }
    ...
    public function destroy(int $id)
    {
        ...
        if (Auth::Id() !== $post->user_id) {
            $post->user->notify(new PostNotification('INFO', 'Bài viết đã bị xóa bởi '.Auth::User()->firstname.' '. Auth::User()->lastname. '.'));
        }
    ...
    public function highlight(Request $request)
    {
        ...
        if ($isHighlighted) {
            ...
            if (Auth::Id() !== $post->user_id) {
                $post->user->notify(new PostNotification('INFO', 'Bài đăng nổi bật.', "/post/$post->slug"));
            }
        }
